                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <input 
                          ...
                          onChange={(e) => setSegmentRange([Number(e.target.value), segmentRange[1]])}
                          className="flex-1 h-1 bg-gray-300 dark:bg-gray-700 rounded-lg appearance-none accent-purple-500"
                        />
                        <span className="text-xs text-gray-500 w-8 text-right">{segmentRange[0]}%</span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <input 
                          ...
                          onChange={(e) => setSegmentRange([segmentRange[0], Number(e.target.value)])}
                          className="flex-1 h-1 bg-gray-300 dark:bg-gray-700 rounded-lg appearance-none accent-purple-500"
                        />
                        <span className="text-xs text-gray-500 w-8 text-right">{segmentRange[1]}%</span>
                      </div>
                    </div>
                  )}
